...
const chartData = [
  { browser: "chrome", visitors: 314300, fill: "var(--color-chrome)" },
  { browser: "safari", visitors: 8800, fill: "var(--color-safari)" },
]
...
export function AssetAlocation() {
  ...
  return (
    <Card className="aspect-square">
      <CardHeader>
        <CardTitle>Asset Alocation</CardTitle>
